$(function() {
	...
	var exampleView = new ExampleView($("#exampleView"),model);
   	...
   	var fullRecipeView = new FullRecipeView($("#showFullRecipe"),model);
   	var fullRecipeViewController = new FullViewController(fullRecipeView,model);
});
...
function goToEdit() {
	...
	document.getElementById("leftMenu").style.display = 'block';
	document.getElementById("instructionsframe").style.display = 'none';
	document.getElementById("showFullRecipe").style.display = 'none';
}
...
function goToFullRecipe() {
	...
	document.getElementById("instructionsframe").style.display = 'none';
	document.getElementById("overview_div").style.display = 'none';
	document.getElementById("showFullRecipe").style.display = 'block';
}
